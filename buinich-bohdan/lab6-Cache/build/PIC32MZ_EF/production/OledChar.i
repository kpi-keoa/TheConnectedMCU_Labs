...
# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\inttypes.h" 1 3
# 46 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\inttypes.h" 3
...
# 47 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\inttypes.h" 2 3


# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\machine\\int_fmtio.h" 1 3
# 50 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\inttypes.h" 2 3
# 48 "OledChar.c" 2
...
int OledDefUserChar(char ch, __uint8_t * pbDef);
...
# 1 "OledGrph.h" 1
# 65 "OledGrph.h"
void OledSetDrawColor(__uint8_t clr);
void OledSetDrawMode(int mod);
int OledGetDrawMode();
__uint8_t * OledGetStdPattern(int ipat);
void OledSetFillPattern(__uint8_t * pbPat);

void OledMoveTo(int xco, int yco);
void OledGetPos(int * pxco, int * pyco);
void OledDrawPixel();
__uint8_t OledGetPixel();
void OledLineTo(int xco, int yco);
void OledDrawRect(int xco, int yco);
void OledFillRect(int xco, int yco);
void OledGetBmp(int dxco, int dyco, __uint8_t * pbBmp);
void OledPutBmp(int dxco, int dyco, __uint8_t * pbBmp);
...
OledDrawGlyph(char ch)
 ...
 if (ch < 0x20) {
  pbFont = pbOledFontUser + ch*8;
 }
 else if ((ch & 0x80) == 0) {
  pbFont = pbOledFontCur + (ch-0x20) * 8;
 }
