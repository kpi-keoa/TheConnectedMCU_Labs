...
# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 1 3
# 32 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 3
# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdarg.h" 1 3
# 75 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdarg.h" 3
...
# 126 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdarg.h" 3
typedef __va_list va_list;
# 33 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 2 3
# 57 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 3
...
# 78 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 3
extern struct _tfiles {
 char tname[81];
 struct _iobuf * tfp;
} * _tfilesptr;
# 163 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 3
...
# 258 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 3
...
# 335 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 3
...
# 391 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\stdio.h" 3
extern int sprintf(char *, const char *, ...);
extern int printf(const char *, ...);
# 15 "main.c" 2
# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\math.h" 1 3
# 37 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\math.h" 3
       
# 91 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\math.h" 3
# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\fdlmath.h" 1 3
# 37 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\fdlmath.h" 3
       
# 49 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\fdlmath.h" 3
extern long double _acosx(long double x);
extern long double _asinx(long double x);
extern long double _atanx(long double x);
extern long double _atan2x(long double y, long double x);
extern long double _ceilx(long double x);
extern long double _cosx(long double x);
extern long double _coshx(long double x);
extern long double _expx(long double x);
extern long double _fabsx(long double x);
extern long double _floorx(long double x);
extern long double _fmodx(long double x, long double y);
extern long double _frexpx(long double x, int *pexp);
extern long double _ldexpx(long double x, int exp);
extern long double _logx(long double x);
extern long double _log10x(long double x);
extern long double _modfx(long double y, long double *pint);
extern long double _powx(long double x, long double y);
extern long double _sinx(long double x);
extern long double _sinhx(long double x);
extern long double _sqrtx(long double x);
extern long double _tanx(long double x);
extern long double _tanhx(long double x);




static inline __attribute__((always_inline)) float acosf(float x)
{
    return (float)_acosx((long double)x);
}
static inline __attribute__((always_inline)) float asinf(float x)
{
    return (float)_asinx((long double)x);
}
static inline __attribute__((always_inline)) float atanf(float x)
{
    return (float)_atanx((long double)x);
}
static inline __attribute__((always_inline)) float atan2f(float y, float x)
{
    return (float)_atan2x((long double)y, (long double)x);
}
static inline __attribute__((always_inline)) float ceilf(float x)
{
    return (float)_ceilx((long double)x);
}
static inline __attribute__((always_inline)) float cosf(float x)
{
    return (float)_cosx((long double)x);
}
static inline __attribute__((always_inline)) float coshf(float x)
{
    return (float)_coshx((long double)x);
}
static inline __attribute__((always_inline)) float expf(float x)
{
    return (float)_expx((long double)x);
}
static inline __attribute__((always_inline)) float fabsf(float x)
{
    return (float)_fabsx((long double)x);
}
static inline __attribute__((always_inline)) float floorf(float x)
{
    return (float)_floorx((long double)x);
}
static inline __attribute__((always_inline)) float fmodf(float x, float y)
{
    return (float)_fmodx((long double)x, (long double)y);
}
static inline __attribute__((always_inline)) float frexpf(float x, int *pexp)
{
    return (float)_frexpx((long double)x, pexp);
}
static inline __attribute__((always_inline)) float ldexpf(float x, int exp)
{
    return (float)_ldexpx((long double)x, exp);
}
static inline __attribute__((always_inline)) float logf(float x)
{
    return (float)_logx((long double)x);
}
static inline __attribute__((always_inline)) float log10f(float x)
{
    return (float)_log10x((long double)x);
}
static inline __attribute__((always_inline)) float modff(float x, float *pint)
{
    long double dpint;
    float r;

    r = (float)_modfx((long double)x, &dpint);
    *pint = (float)dpint;

    return r;
}
static inline __attribute__((always_inline)) float powf(float x, float y)
{
    return (float)_powx((long double)x, (long double)y);
}
static inline __attribute__((always_inline)) float sinf(float x)
{
    return (float)_sinx((long double)x);
}
static inline __attribute__((always_inline)) float sinhf(float x)
{
    return (float)_sinhx((long double)x);
}
static inline __attribute__((always_inline)) float sqrtf(float x)
{
    return (float)_sqrtx((long double)x);
}
static inline __attribute__((always_inline)) float tanf(float x)
{
    return (float)_tanx((long double)x);
}
static inline __attribute__((always_inline)) float tanhf(float x)
{
    return (float)_tanhx((long double)x);
}


static inline __attribute__((always_inline)) long double acosl(long double x)
{
    return (long double)_acosx((long double)x);
}
static inline __attribute__((always_inline)) long double asinl(long double x)
{
    return (long double)_asinx((long double)x);
}
static inline __attribute__((always_inline)) long double atanl(long double x)
{
    return (long double)_atanx((long double)x);
}
static inline __attribute__((always_inline)) long double atan2l(long double y, long double x)
{
    return (long double)_atan2x((long double)y, (long double)x);
}
static inline __attribute__((always_inline)) long double ceill(long double x)
{
    return (long double)_ceilx((long double)x);
}
static inline __attribute__((always_inline)) long double cosl(long double x)
{
    return (long double)_cosx((long double)x);
}
static inline __attribute__((always_inline)) long double coshl(long double x)
{
    return (long double)_coshx((long double)x);
}
static inline __attribute__((always_inline)) long double expl(long double x)
{
    return (long double)_expx((long double)x);
}
static inline __attribute__((always_inline)) long double fabsl(long double x)
{
    return (long double)_fabsx((long double)x);
}
static inline __attribute__((always_inline)) long double floorl(long double x)
{
    return (long double)_floorx((long double)x);
}
static inline __attribute__((always_inline)) long double fmodl(long double x, long double y)
{
    return (long double)_fmodx((long double)x, (long double)y);
}
static inline __attribute__((always_inline)) long double frexpl(long double x, int *pexp)
{
    return (long double)_frexpx((long double)x, pexp);
}
static inline __attribute__((always_inline)) long double ldexpl(long double x, int exp)
{
    return (long double)_ldexpx((long double)x, exp);
}
static inline __attribute__((always_inline)) long double logl(long double x)
{
    return (long double)_logx((long double)x);
}
static inline __attribute__((always_inline)) long double log10l(long double x)
{
    return (long double)_log10x((long double)x);
}
static inline __attribute__((always_inline)) long double modfl(long double x, long double *pint)
{
    long double dpint;
    long double r;

    r = (long double)_modfx((long double)x, &dpint);
    *pint = (long double)dpint;

    return r;
}
static inline __attribute__((always_inline)) long double powl(long double x, long double y)
{
    return (long double)_powx((long double)x, (long double)y);
}
static inline __attribute__((always_inline)) long double sinl(long double x)
{
    return (long double)_sinx((long double)x);
}
static inline __attribute__((always_inline)) long double sinhl(long double x)
{
    return (long double)_sinhx((long double)x);
}
static inline __attribute__((always_inline)) long double sqrtl(long double x)
{
    return (long double)_sqrtx((long double)x);
}
static inline __attribute__((always_inline)) long double tanl(long double x)
{
    return (long double)_tanx((long double)x);
}
static inline __attribute__((always_inline)) long double tanhl(long double x)
{
    return (long double)_tanhx((long double)x);
}


static inline __attribute__((always_inline)) double acos(double x)
{
    return (double)_acosx((long double)x);
}
static inline __attribute__((always_inline)) double asin(double x)
{
    return (double)_asinx((long double)x);
}
static inline __attribute__((always_inline)) double atan(double x)
{
    return (double)_atanx((long double)x);
}
static inline __attribute__((always_inline)) double atan2(double y, double x)
{
    return (double)_atan2x((long double)y, (long double)x);
}
static inline __attribute__((always_inline)) double ceil(double x)
{
    return (double)_ceilx((long double)x);
}
static inline __attribute__((always_inline)) double cos(double x)
{
    return (double)_cosx((long double)x);
}
static inline __attribute__((always_inline)) double cosh(double x)
{
    return (double)_coshx((long double)x);
}
static inline __attribute__((always_inline)) double exp(double x)
{
    return (double)_expx((long double)x);
}
static inline __attribute__((always_inline)) double fabs(double x)
{
    return (double)_fabsx((long double)x);
}
static inline __attribute__((always_inline)) double floor(double x)
{
    return (double)_floorx((long double)x);
}
static inline __attribute__((always_inline)) double fmod(double x, double y)
{
    return (double)_fmodx((long double)x, (long double)y);
}
static inline __attribute__((always_inline)) double frexp(double x, int *pexp)
{
    return (double)_frexpx((long double)x, pexp);
}
static inline __attribute__((always_inline)) double ldexp(double x, int exp)
{
    return (double)_ldexpx((long double)x, exp);
}
static inline __attribute__((always_inline)) double log(double x)
{
    return (double)_logx((long double)x);
}
static inline __attribute__((always_inline)) double log10(double x)
{
    return (double)_log10x((long double)x);
}
static inline __attribute__((always_inline)) double modf(double x, double *pint)
{
    long double dpint;
    double r;

    r = (double)_modfx((long double)x, &dpint);
    *pint = (double)dpint;

    return r;
}
static inline __attribute__((always_inline)) double pow(double x, double y)
{
    return (double)_powx((long double)x, (long double)y);
}
static inline __attribute__((always_inline)) double sin(double x)
{
    return (double)_sinx((long double)x);
}
static inline __attribute__((always_inline)) double sinh(double x)
{
    return (double)_sinhx((long double)x);
}
static inline __attribute__((always_inline)) double sqrt(double x)
{
    return (double)_sqrtx((long double)x);
}
static inline __attribute__((always_inline)) double tan(double x)
{
    return (double)_tanx((long double)x);
}
static inline __attribute__((always_inline)) double tanh(double x)
{
    return (double)_tanhx((long double)x);
}
# 92 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\math.h" 2 3
double rint (double);
float rintf (float);
long double rintl (long double);
# 106 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\math.h" 3
int finite (double) __attribute__((__const));
int finitef (float) __attribute__((__const));
int finitel (long double) __attribute__((__const));
int isinf (double) __attribute__((__const));
int isinff (float) __attribute__((__const));
int isinfl (long double) __attribute__((__const));
int isnan (double) __attribute__((__const));
int isnanf (float) __attribute__((__const));
int isnanl (long double) __attribute__((__const));
# 125 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\math.h" 3
extern long double _expm1x(long double x);
static inline __attribute__((always_inline)) float expm1f(float x)
{
    return (float)_expm1x((long double)x);
}
static inline __attribute__((always_inline)) double expm1(double x)
{
    return (double)_expm1x((long double)x);
}
static inline __attribute__((always_inline)) long double expm1l(long double x)
{
    return (long double)_expm1x((long double)x);
}
...
extern double copysign (double, double) __attribute__((__const));
extern float copysignf (float, float) __attribute__((__const));
extern long double copysignl (long double, long double) __attribute__((__const));
...
# 403 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\math.h" 3
extern unsigned int __attribute__((section(".data.math_errhandling_flag"))) math_errhandling;
# 16 "main.c" 2
# 25 "main.c"
int dummy[(4096) / sizeof (int)];
int aa[(16)][((16))];
...
__int32_t main(void) {
    ...
    while (1) {
        sprintf(buffer, "%u*%u array", (16), ((16)));
        OledSetCursor(0, 1);
       ...
       t_test = Timed_Array_Test_CR((16), ((16)), aa, &sum);

        sprintf(buffer, "%6u T2 ticks", t_test);
        OledSetCursor(0, 2);
        OledPutString(buffer);

        sprintf(buffer, "%6.3f CPU cy/el", (4.0*t_test)/((16)*((16))));
        OledSetCursor(0, 3);
        OledPutString(buffer);
    }
}
